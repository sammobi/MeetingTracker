...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerAdapter = new RecyclerAdapter(getActivity(), mEventDetailArrayList);
    ...
    public ArrayList<EventDetail> getGridList() {
        mEventGridArrayList = new ArrayList<EventDetail>();


        return mEventGridArrayList;
